...
const LiquidButton = class LiquidButtons {
  constructor(svg) {
    ...
    this.height = options.height * 1 || 45;
    this.margin = options.margin || 50;
    this.hoverFactor = options.hoverFactor || -0.1;
    this.gap = options.gap || 5;
    this.debug = options.debug || false;
    this.forceFactor = options.forceFactor || 0.2;
    this.color1 = options.color1 || '#ff7817';
    this.color2 = options.color2 || '#ff7817';
    this.color3 = options.color3 || '#e76000';
